                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="category" class="form-select @error('category') is-invalid @enderror" required>
                                ...
                                <option value="medical" {{ old('category') == 'medical' ? 'selected' : '' }}>طبي</option>
                                <option value="shelter" {{ old('category') == 'shelter' ? 'selected' : '' }}>إيواء</option>
                                <option value="edu" {{ old('category') == 'edu' ? 'selected' : '' }}>تعليم</option>
                                <option value="org" {{ old('category') == 'org' ? 'selected' : '' }}>مؤسسات</option>
                                <option value="water" {{ old('category') == 'water' ? 'selected' : '' }}>مياه</option>
                            </select>
                            @error('category')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="working_hours" class="form-control" rows="2" 
                                      placeholder="مثال: من الأحد إلى الخميس: 8 صباحاً - 4 مساءً">{{ old('working_hours') }}</textarea>
                        </div>
